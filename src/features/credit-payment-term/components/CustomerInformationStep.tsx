        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <FormGroup label="ค้นหาลูกค้า" required error={errors.existingCustomerId}>
            ...
            {searchResults.length > 0 && (
              <div style={{ border: '1px solid #E2E8F0', borderRadius: 8, marginTop: 4, background: '#fff', boxShadow: '0 4px 12px rgba(0,0,0,0.08)', overflow: 'hidden' }}>
                {searchResults.map(c => (
                  <button
                    key={c.id}
          ...
          {existingCustomerId && (
            <div style={{ padding: 16, background: '#EBF0F6', borderRadius: 8, border: '1px solid #BFD0E5' }}>
